...
In \ref{AppendixB} we present the Mathematica code for calculating electron energies of the molecular $ H_2^{+} $ ion in 3 dimensions using Mathematica eigenvalue solver.
