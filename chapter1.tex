...
\begin{figure}
    \noindent\includegraphics[width=\textwidth]{H2Ion3D-2}
...
Electron energy as an eigenvalue of the equations \eqref{bandL} and \eqref{bandM}.
\begin{figure}
  \includegraphics{Bates3DEofRPlusVofR-2}
...
For reference we use the values obtained by Bates \cite{Bates1}\cite{Bates2}. Valued obtained by our method are is good alignment with the referent values.
