...
\noindent\includegraphics[width=1\textwidth]{Ger-Lcao-Graphs}
\end{figure}
\vspace{-10.cm}
\begin{figure}[!htp]
  \caption{Gerade Orbitals in 3D}\par\medskip
\noindent\includegraphics[width=1\textwidth]{Ger-Lcao-3D-Graphs}
\end{figure}
\vspace{-10.cm}
\begin{figure}[H]
  \caption{Ungerade Orbitals}\par\medskip
\noindent\includegraphics[width=1\textwidth]{UnGer-Lcao-Graphs}
\end{figure}

\begin{figure}[H]
  \caption{Ungerade Orbitals 3D}\par\medskip
\noindent\includegraphics[width=1\textwidth]{UnGer-Lcao-3D-Graphs}
\end{figure}
