...
In chapter \ref{h2plus2DPotential} we shall compute the accurate solution of the 2D potential. Here for illustration, in Table \ref{tab:lcaotabG}, we present LCAO values for the gerade state, and compare it to the accurate results obtained in the discussions of te chapter \ref{h2plus2DPotential}.
...
\includegraphics{"Vg-Vs-LCAO-good"}
  \caption{A.ccurate potential curve (red) vs LCAO approximation (blue) for the $ H_2^{+} $ ground gerade state}
  \label{vgvslcao}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[scale=0.25]{Ger-Lcao-Graphs}
...
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[width=\linewidth]{Ger-Lcao-3D-Graphs}
    \caption{Gerade Orbitals in 3D from the same LCAO approximation. The graph shows the magnitude of the potential function for different values values of the internuclear distance R}
\end{figure}
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[scale=0.25]{UnGer-Lcao-Graphs}
...
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[width=\linewidth]{UnGer-Lcao-3D-Graphs}
