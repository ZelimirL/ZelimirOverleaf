...
\chapter{Molecular potential for the $ H_2^+ $ molecule in 2D}
...
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[width=\linewidth]{Ger-Lcao-Graphs}
    \caption{Gerade Orbitals obtained from the LCAO approximation}
\end{figure}
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[width=\linewidth]{Ger-Lcao-3D-Graphs}
    \caption{Gerade Orbitals in 3D from the same LCAO approximation}
\end{figure}
\begin{figure}[ht]
    \centering
