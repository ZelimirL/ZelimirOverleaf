...
\includegraphics[alt={Accurate and LCAO ground-gerade energy curves versus internuclear distance R. The approximations differ substantially at short range but both approach minus 2 Hartree as R increases.}]{Vg-Vs-LCAO-good}
  \caption{Accurate potential curve (red) vs LCAO approximation (blue) for the $ H_2^{+} $ ground gerade state}
  \label{vgvslcao}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Ungerade orbitals in 3D  from the same LCAO approximation. The graph shows the magnitude of the potential function for different values of the internuclear distance R}
\end{figure}
