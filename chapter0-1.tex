...
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[width=\linewidth]{UnGer-Lcao-Graphs}
    \caption{Ungerade Orbitals obtained from the LCAO approximation}
\end{figure}
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[width=\linewidth]{UnGer-Lcao-3D-Graphs}
    \caption{Ungerade Orbitals 3D  from the same LCAO approximation}
\end{figure}
