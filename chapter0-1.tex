...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption{Gerade Orbitals}\par\medskip
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \noindent\includegraphics[width=\linewidth]{Ger-Lcao-3D-Graphs}
    \caption{Gerade Orbitals in 3D}\par\medskip
  \end{subfigure}
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \noindent\includegraphics[width=\linewidth]{UnGer-Lcao-Graphs}
    \caption{Ungerade Orbitals}\par\medskip
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \noindent\includegraphics[width=\linewidth]{UnGer-Lcao-3D-Graphs}
    \caption{Ungerade Orbitals 3D}\par\medskip
  \end{subfigure}
  \caption*{Plot of LCAO potentials}
  \end{figure}
