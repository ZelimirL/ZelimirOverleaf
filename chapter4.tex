...
\begin{figure}[hbtp]
  \centering
  \text{Gerade}
  \includegraphics[width=1.2\textwidth]{Ger-Lcao-Graphs.pdf}
\end{figure}
\begin{figure}[hbtp]
  \text{Gerade in 3D}
  \includegraphics[width=1\textwidth]{Ger-Lcao-3D-Graphs.pdf}
\end{figure}
\vspace*{-1\baselineskip}
\begin{figure}[hbtp]
  \centering
  \text{Ungerade}
  \includegraphics[width=1.2\textwidth]{UnGer-Lcao-Graphs.pdf}
\end{figure}
\begin{figure}[hbtp]
  \includegraphics[width=1.2\textwidth]{UnGer-Lcao-3D-Graphs.pdf}
\end{figure}
