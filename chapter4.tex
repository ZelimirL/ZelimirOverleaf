...
The Mathematica code is in appendix \ref{AppendixF}
...
Finally the scatterting cross section changes to:
\begin{equation}
  \sigma(k;\alhpa) = \frac{4}{k}\sum_{m=-\infty}^{+\infty}{\sin^2(\delta_{m+\beta})}
\end{equation}
