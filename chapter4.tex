...
TODO: Add appendix
The Mathematica code that computes the phase shift and the cross section  is in appendix

It is now fairly straightforward to compute the scattering cross section
