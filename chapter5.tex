...
Note that the terms proportional to $ f_{AB}(\phi) $ cancel as they are independent of the gerade/ungerade potentials. The restriction to odd values of $ m$ is determined by the fermionic symmetry requirement of the base $(\alpha=0)$ system.  

\ection{Calculations and Discussion}
