...
In this section we describe the charge transfer in 2 dimension, analogous to the approach we tok in chapter \autoref{chp:quenching}
...
Following the similar approach as in chapter 4 the radiative charge transfer cross-section can be calculated using the formula \eqref{crs1} for $ \sigma $ with $ M $ calculated using formula \eqref{Mll1}, where the $ k_a $ and $ k_b $ are the wave numbers of the initial and final state. 
