...
Here, we follow the procedure of Aharonov-Bohm and expand $ F(\pmb{R}) $ in terms of single-valued function $ e^{im\phi} $ , $ m = 0, \pm 1, ... $. resulting in the the radial equations \eqref{AHBeq1} (cite Aharonov Bohm)
\begin{equation}
