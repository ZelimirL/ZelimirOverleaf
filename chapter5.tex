...
\end{split}
\end{equation}
Note that if we impose a singular gauge transformation $ F({\bf R}) \rightarrow \exp(i \, \alpha \, \phi) {\tilde F}({\bf R}) $ then $ {\tilde F}(\bf R}) $ obeys the standard Schrodinger without the presence of a flux tube, however, the pre-factor $\exp(i \, \alpha )$ introduces multi-valuedness in the total amplitude and special methods
