\section{Resonant Charge Transfer in Two Dimensions}
\label{chap:RRP2}
...
The nuclei of the H molecule are identical particles, and so we must enforce symmetry constraints for the latter. Symmetrization requires the inclusion of the spin degree of freedom, and here, for now, we assume that both nuclei are spin-polarized. Therefore, under traditional interpretations in which the nuclei are fermions, we take the spatial component of the wave amplitude to be antisymmetric under interchange
\begin{equation}
F({\bf R},{\bf r}) = \psi_{g}({\bf R}) \phi_{g}({\bf R},{\bf r}) + \psi_{u}({\bf R}) \phi_{u}({\bf R},{\bf r})
\end{equation}
...
\begin{figure}[htp]
  \includegraphics[width=\textwidth,alt={Cartoon illustrating flux attachment: a hand uses the momentum-minus-charge-times-vector-potential operator to attach a thin magnetic flux tube to a particle confined to a two-dimensional grid.}]{fluxtube}
  \caption{Illustration of anyon as a particle-flux tube composite. Illustration taken from D.  P. Avoras ”Geometric Phases in Physics”, pg. 287, ed. A. Shapere and F. Wilczek, World Scientific (1989)}
  \label{fluxt}
\end{figure}
...
\end{equation}
is a gauge potential \cite{YSWU}. Here $ {\bf n}$ is a unit normal vector to the 2D scattering plane and $ 0 < \alpha <1. $ Introducing the relative coordinates
...
\begin{figure} [H]  
    \centering 
    \includegraphics[width=\textwidth,alt={Four stem plots at 1 kelvin showing squared partial-wave amplitude differences versus integer m for bosonic and fermionic bases at flux parameters alpha zero and one. The dominant peaks shift between even and odd m according to base statistics and flux.}]{fig1a.pdf}
    \caption{Collision temperature $T= 1 \, K. $ Blue icons refer to a bosonic base, and red icons to a fermionic base.}
    \label{fig:t1-integer-flux} 
\end{figure}

\begin{figure} [H]  
    \centering 
    \includegraphics[width=0.7\textwidth,alt={Combined stem plot at 1 kelvin and alpha equals one half. Bosonic and fermionic amplitudes occupy alternating m values, with the largest peaks near m equals minus 2 and 3.}]{fig1b.pdf}
    \caption{Collision temperature $T= 1 \, K. $ Blue icons refer to a bosonic base, and red icons to a fermionic base. }
    \label{fig:t1-semion} 
\end{figure}
...
\begin{figure} [H] 
    \centering 
    \includegraphics[width=\textwidth,alt={Four stem plots at 10 kelvin showing squared partial-wave amplitude differences versus m for bosonic and fermionic bases at alpha zero and one. More partial waves contribute than at 1 kelvin, and the dominant peaks again shift with statistics and flux.}]{fig2a.pdf}
    \caption{Collision temperature $T=10 \, K.$ Blue icons refer to a bosonic base, and red icons to a fermionic base. }
    \label{fig:t10-integer-flux} 
\end{figure}

\begin{figure} [H] 
    \centering 
    \includegraphics[width=0.7\textwidth,alt={Combined stem plot at 10 kelvin and alpha equals one half. Alternating bosonic and fermionic contributions extend from about m equals minus 5 to plus 5, with dominant peaks near minus 3, minus 2, 3, and 4.}]{fig2b.pdf}
    \caption{Collision temperature $ T=10 \, K. $ Blue icons refer to a bosonic base, and red icons to a fermionic base. }
    \label{fig:t10-semion}
\end{figure}


\begin{figure} [H] 
    \centering 
    \includegraphics[width=\textwidth,alt={Four stem plots at 100 kelvin showing squared partial-wave amplitude differences versus m for bosonic and fermionic bases at alpha zero and one. Significant contributions extend across approximately m equals minus 7 through plus 7.}]{fig3a.pdf}
    \caption{Collision temperature $T=100 \, K. $ Blue icons refer to a bosonic base, and red icons to a fermionic base. }
    \label{fig:t100-integer-flux} 
\end{figure}

\begin{figure} [H] 
    \centering 
    \includegraphics[width=0.7\textwidth,alt={Combined stem plot at 100 kelvin and alpha equals one half. Bosonic and fermionic contributions alternate over m from about minus 7 to plus 7, with several comparable high peaks.}]{fig3b.pdf}
    ...
    \label{fig:t100-semion} 
\end{figure}


\begin{figure} [H] 
    \centering 
    \includegraphics[width=0.9\textwidth,alt={Total resonant charge-transfer cross section versus temperature from 1 to 100 kelvin. Bosonic and fermionic alpha-zero curves show different low-temperature maxima and converge at higher temperature; the alpha-one-half semion curve oscillates between them and approaches the same high-temperature range.}]{CT.pdf}
    \caption{Total RCT cross sections. Solid lines refer to $ \alpha=0$ (i.e., absence of flux tube), for the bosonic base (Blue line) and the fermionic base (Red line) respectively. The dashed line refers to a semion $(\alpha=1/2)$, and the cross section is identical for both fermionic and bosonic bases.}
     \label{fig:total-rct} % this internally labels the figure for future referencing.
\end{figure}
