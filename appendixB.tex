...
% The former PDF insertion was an untagged page image after import.  A text
% transcript keeps the Mathematica notebook content available to assistive
% technology.  The original PDF is retained with the project for reference.
\begingroup
\small
\SuspendTagging{appendixB-verbatim}
\verbatiminput{Bates-Reproduce-3D-accessible.txt}
\ResumeTagging{appendixB-verbatim}
\endgroup
