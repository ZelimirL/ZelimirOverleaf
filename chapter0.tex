...
\begin{figure}[H]
  ...
  \caption{R-dependent Einstein A coeﬃcient as a function of internuclear distance}
\end{figure}
...
\begin{equation}
  V_A(R) \rightarrpw \frac{C_4^A}{R^4}\,\,\,\,\,C_4^A = 78.5
\end{equation}
