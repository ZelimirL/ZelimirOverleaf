...
In the Radiative Charge Transfer there is an emission of a photon. It is governed by the dipole matrix element $ D(R) = \mel{\psi_g}{r}{\psi_u} $ where $ \ket{\psi_g} $ and $ \ket{\psi_u} $ are the wavefunctions associated with the gerade and ungerade potentials and $ r $ is the location of the electron. 

The proces  is The proces is $ H^+ + H \rightarrow H + H^+ + \gamme $. \\
