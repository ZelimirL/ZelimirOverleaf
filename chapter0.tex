...
We can summarize the current chapter as completing two things. First we have shown the range of partial waves (angular momentum $ J $ where optical potential method provides a very good approximation.  \\
