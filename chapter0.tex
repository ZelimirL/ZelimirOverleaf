...
f_{J}(kR) \longrightarrow \sqrt{\frac{2\mu}{\pi k}}\sin(kR - \frac{J\pi}{2} + \delta_J)
\end{equation}
...
The alternative way to compute the cross section is to use the local optical potential method \cite{Zygelman88}.  The loss of flux from the entrance channel equals the radiative probability, which is convert to a radiative cross section.
