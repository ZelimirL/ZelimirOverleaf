...
Fairly recently there has beed advances in trapping, cooling, and  manipulation of ultra-cold atom. The development of hybrid, ion-atom traps has allowed researchers to explore the competing pathways, including non-radiative and radiative charge transfer as well as radiative association, in which ions and atoms re-combine and re-arrange at cold temperatures. 
...
In the following section we a provide a rigorous upper bound for the sum of rates given in \eqref{Eq1}.
