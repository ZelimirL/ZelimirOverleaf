...
Finally, while naturally occuring 2D atoms and molecules do not exist, excitons are proven to exist, and they are analogous to the 2D atoms. So we explore the $ H_2 $ molecule so that we gain insights that can be translated into excitons.
