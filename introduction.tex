...
Arguable quantum mechanics (QM), or the quantum theory, offers the best description of matter's behavior at the atomic, molecular, and subnuclear level. As an established paradigm, it is being applied to increasingly more complex systems where physics and other disciplines intersect.
...
The statement above is generally true and applicable to every project and solution \textcolor{red}{I am not sure what this sentence means}. Therefore, for this case, we first seek analytic solutions and fall back to the numerical computation at  the last step. Thus, while quantum mechanics can be applied to any physical system, in this thesis, we focus on two major applications: novel 2-dimensional materials and their application to quantum computing\textcolor{how}.
\subsection*{New Materials}
Quantum mechanics has allowed the development of novel electronic components, lasers, high-speed telecommunications, new diagnostic technologies in medicine, and new materials. 

After more than twenty years of gestation, at the beginning of the 20th century, quantum mechanics has been applied to an increasingly complex system. One of which is a deeper understanding of the properties of materials. That understanding has led to the creation of new materials, including so-called 2D materials.
