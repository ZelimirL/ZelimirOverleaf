...
\end{equation}
and we can integrate out the degrees of freedom associated with the electrons and derive an effective Schrödinger description, for the amplitudes $F_{n}(\bf R)$ that describe the motion of the nucleii. In Chapter \ref{chap:RRP}, we will apply this method to calculate 
