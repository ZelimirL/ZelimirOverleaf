...
\subsection{Main Applications}
 While quantum mechanics can be applied to any physical system, in this thesis, we focus on two major applications: novel 2-dimensional materials and their application to quantum computing\textcolor{how}.
