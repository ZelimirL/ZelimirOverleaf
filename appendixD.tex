...
\begin{lstlisting}[language=Fortran,basicstyle=\ttfamily\scriptsize,breaklines=true,breakatwhitespace=false,columns=fullflexible,keepspaces=true,showstringspaces=false,linewidth=\linewidth]
! To Compile 
