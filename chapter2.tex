...
\subsection{Energy}
 ...
 The appendixD also contains a Wolfram Mathematica code used to obtain a values for electronic energy $ E(R) $, total potential $ V(R) $ for the  $ 1s_g^{+} $ and $2s_{g}^{+} $ states. 
...
afterpage{
  ...
  \begin{tabular}{ |l|l|l|l|l| }
      ...
      \multicolumn{1}{r}{} &
      \multicolumn{1}{r}{$ 2s_g^+ $ } \\
      \hline
       & $ E_{ele} $ & $ E_{tot} $ & $ E_{ele} $ & $ E_{tot} $  \\ 
      0.1 & -7.18911 & 2.81089 & 1 & 1 \\
      0.2 & -6.38244 & -1.38244 & 1 & 1 \\
      0.3 & -5.73001 & -2.39668 & 1 & 1 \\
      0.4 & -5.2088 & -2.7088 & 1 & 1 \\
