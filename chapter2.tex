...
The Mathematica code is in appendix \ref{AppendixC}. The energies calculated and the plot of the potential for the states $1s_g^{+}$ and $ 2p_u^{+} $ are in the tables below.
