...
\afterpage{
  ...
  \label{1sg}
      ...
      0.1 & 0.1915 & 7.2704 & -7.3359 & 2.66401 \\[-1em]
...
\afterpage{
  ...
  \label{2sg}
		\begin{tabular}{ >{\bfseries}m{6em} m{6em}  m{6em}  m{6em} m{6em} }
			\hline
			R & p & A & E & $ E + \frac{1}{R} $ \\ \hline \hline
      0.1 &0.0710 & 15.8560 & -1.0102 & 8.98975 \\[-1em]
...
Appendix D  Wolfram Mathematica a program for calculating the energies.

However it appears that the brute force approach yields somewhat worse results.

\afterpage{
  \newgeometry{left=4em,right=3em,top=5em,bottom=5em}
  \captionof{table}{ $ 1s_g^{+} $ } \label{tab:2pu}
		\begin{tabular}{ m{6em} m{6em}  m{6em}  m{6em} m{6em} }
		\hline
		    R & p & A & E & $ E + \frac{1}{R} $ \\ \hline \hline
        0.2 & 0.2031 & 0.0206 & -2.0636 & 2.9363 \\[-1em]
        0.3 & 0.2874 & 0.0415 & -1.8358 & 1.4975 \\[-1em]
        0.4 & 0.6483 & 0.2156 & -5.2538 & -2.7538 \\[-1em]
        0.5 & 0.7763 & 0.3126 & -4.8216 & -2.8216 \\[-1em]
        0.6 & 0.8968 & 0.4223 & -4.4686 & -2.8019 \\[-1em]
        0.7 & 1.0115 & 0.5440 & -4.1760 & -2.7474 \\[-1em]
        0.8 & 1.1214 & 0.6777 & -3.9304 & -2.6804 \\[-1em]
        0.9 & 1.2277 & 0.8236 & -3.7220 & -2.6109 \\[-1em]
        1.0 & 1.3311 & 0.9820 & -3.5436 & -2.5436 \\[-1em]
        1.5 & 1.7848 & 1.8037 & -2.8318 & -2.1651 \\[-1em]
        2.0 & 1.9182 & 1.3252 & -1.8398 & -1.3398 \\[-1em]
        2.5 & 1.9383 & 0.2865 & -1.2022 & -0.8022 \\[-1em]
        3.0 & 1.9588 & -0.7551 & -0.8526 & -0.5193 \\[-1em]
        3.5 & 2.1000 & -2.2367 & -0.7200 & -0.4342 \\[-1em]
        4.0 & 2.1121 & -2.2039 & -0.5576 & -0.3076 \\[-1em]
        4.5 & 2.3541 & -1.8836 & -0.5473 & -0.3251 \\[-1em]
        5.0 & 2.5797 & -1.5553 & -0.5323 & -0.3323 \\[-1em]
        6.0 & 2.9869 & -0.9144 & -0.4956 & -0.3290 \\[-1em]
        7.0 & 3.3539 & -0.2604 & -0.4591 & -0.3162 \\[-1em]
        8.0 & 3.6945 & 0.4400 & -0.4265 & -0.3015 \\[-1em]
        9.0 & 4.0177 & 1.2162 & -0.3985 & -0.2874 \\[-1em]
...
\afterpage{
  ...
  \captionof{table}{ $ 2s_g^{+} $ } \label{tab:2pu}
		...
		\hline
		    R & p & A & E & $ E + \frac{1}{R} $ \\ \hline \hline
        0.2 & 0.1988 & 0.0198 & -1.9764 & 3.0235` \\[-1em]
        0.3 & 0.3290 & 0.0545 & -2.4061 & 0.9272 \\[-1em]
        0.4 & 0.3284 & 0.0543 & -1.3484 & 1.1515 \\[-1em]
        0.5 & 0.2995 & 0.0451 & -0.7179 & 1.2820 \\[-1em]
        0.6 & 0.2801 & 0.0394 & -0.4360 & 1.2306 \\[-1em]
        0.7 & 0.4074 & 0.0838 & -0.6774 & 0.7510 \\[-1em]
        0.8 & 0.4583 & 0.1063 & -0.6563 & 0.5936 \\[-1em]
        0.9 & 0.5080 & 0.1311 & -0.6374 & 0.4736 \\[-1em]
        1.0 & 0.5574 & 0.1583 & -0.6214 & 0.3785 \\[-1em]
        1.1 & 0.6047 & 0.1870 & -0.6045 & 0.3044 \\[-1em]
        1.5 & 0.7887 & 0.3230 & -0.5529 & 0.1137 \\[-1em]
        2.0 & 1.0048 & 0.5365 & -0.5048 & -0.0040 \\[-1em]
        2.5 & 1.2100 & 0.7982 & -0.4685 & -0.0680 \\[-1em]
        3.0 & 1.4072 & 1.1096 & -0.4400 & -0.1067 \\[-1em]
        3.5 & 1.5984 & 1.4732 & -0.4171 & -0.1314 \\[-1em]
        4.0 & 1.7690 & 1.7037 & -0.3911 & -0.1411 \\[-1em]
        4.5 & 1.9109 & 1.6840 & -0.3606 & -0.1384 \\[-1em]
        5.0 & 1.9374 & 0.3310 & -0.3003 & -0.1003 \\[-1em]
        6.0 & 1.9970 & -2.2878 & -0.2215 & -0.0549 \\[-1em]
        7.0 & 2.2709 & -2.0010 & -0.2105 & -0.0676 \\[-1em]
        8.0 & 2.5364 & -1.6194 & -0.2010 & -0.0760 \\[-1em]
        9.0 & 2.7887 & -1.2354 & -0.1920 & -0.0809 \\[-1em]
