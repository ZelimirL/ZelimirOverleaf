...
\begin{table}[h!]
  \caption{ The separation constant A, electronic energy E}{ total energy $ E + \frac{1}{R} $ , for the state $ 1s_u^{+} $ for some values of the inter-nuclear separation R } 
  \centering
  \label{2sg}
		\begin{tabular}{ m{6em} m{6em}  m{6em}  m{6em} m{6em} }
			\hline
...
\begin{figure}
  \includegraphics[width=\textwidth]{H2_1Sg-Potential}
  \caption{$ H_2^{+} $ Energy and Potential curves for the $ 1s_g^{+} $ state}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{H2_1Su-Potential}
  \caption{$ H_2^{+} $ Energy and Potential curves for the $ 1s_u^{+} $ state}
\end{figure}


\begin{figure}
  \includegraphics{	H2_sGpU-Potential}
