%\chapter[Appendix A: Center of Mass as a Plane Wave]
        {Center of Mass as a Plane Wave}
\label{AppendixA}
...
& H\Ket{\phi} = (H_{CM} + H_{r})(\Ket{\chi} \otimes \Ket{\omega}) =  \\[.8em]
  & H_{CM}(\Ket{\chi} \otimes \Ket{\omega}) + H_{r}(\Ket{\chi} \otimes \Ket{\omega}) = \\[.8em]
&(E_{CM} + E_{r})(\Ket{\chi} \otimes \Ket{\omega})
\end{split}
\end{equation}
